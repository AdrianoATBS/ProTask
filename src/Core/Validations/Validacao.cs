...
public class Validacao
{
    ...
    public static ValidationResult ValidarUltimoLogin(DateTime ultimoLogin)
    {
        return ultimoLogin <= DateTime.UtcNow
            ? new ValidationResult(true)
            : new ValidationResult(false, "Último login não pode ser no futuro");
    }
}
